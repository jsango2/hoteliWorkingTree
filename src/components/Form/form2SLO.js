  ...
  render() {
    ...
    return (
      <>
        <FormWrap>
          <FormTitle>
            Dogovorite se za demo predstavitev, prilagojeno vašim potrebam
          </FormTitle>
          ...
          <FieldsWrap>
            ...
            >
              ...
              <input
                type="text"
                placeholder="Kateri hotelski sistem uporabljate?"
                name="sustav"
                required
                value={sustav}
                onChange={this.handleChange}
              ...
              <button type="submit">KONTAKTIRAJTE ME </button>
              {/* <input
